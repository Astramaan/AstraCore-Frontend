...
const allRoles: RoleData[] = [
    { name: "Super Admin", icon: Shield, bgColor: "bg-red-200/30 dark:bg-red-500/20" },
    { name: "Sales", icon: Briefcase, bgColor: "bg-yellow-400/30" },
    ...
    { name: "Support & Feedback", icon: Users, bgColor: "bg-green-300/30 dark:bg-green-500/20" },
