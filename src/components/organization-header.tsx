      ...
      <div className="flex items-center gap-4">
        ...
        {pageTitle && (
          <>
            ...
            <h2 className="hidden md:block text-xl md:text-2xl lg:text-[32px] lg:leading-[40px] font-semibold text-white">
              {pageTitle}
            </h2>
          </>
        )}
          ...
          <>
            <Link href={`/organization/${organizationId}/teams`}>
              <div className="relative p-px rounded-full bg-gradient-to-br from-white/50 to-white/0 dark:from-white/20 dark:to-white/0">
                <Button
                  className={cn(
                    "group rounded-full h-[54px] px-4 lg:px-10 text-base lg:text-lg font-medium flex items-center backdrop-blur-sm",
                    isTeamsActive
                      ? "bg-primary text-primary-foreground"
                      : "bg-black/20 dark:bg-black/30 text-white hover:bg-primary/10 dark:hover:bg-primary/20",
                  )}
                >
                  <TeamIcon
                    className={cn(
            ...
            <Link
              href={`/organization/${organizationId}/profile`}
          ...
          <SheetTrigger asChild>
            <div className="relative p-px rounded-full bg-gradient-to-br from-white/50 to-white/0 dark:from-white/20 dark:to-white/0">
              <Button
                variant="ghost"
                size="icon"
                className="bg-black/10 dark:bg-black/20 backdrop-blur-sm rounded-full h-12 w-12 hover:bg-primary/10 hover:text-primary relative text-white"
              >
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mt-auto">
                <Button
                  variant="outline"
                  onClick={logout}
                  className="w-full justify-center rounded-full h-12 text-base text-destructive hover:bg-destructive/10 hover:text-destructive"
                >
