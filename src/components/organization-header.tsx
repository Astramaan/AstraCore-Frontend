                ...
                <>
                        ...
                        <div className="relative p-px rounded-full bg-gradient-to-br from-white/50 to-white/0 dark:from-white/20 dark:to-white/0">
                             <Button className={cn(
                                ...
                                <TeamIcon className={cn(
                                    "mr-2 h-6 w-6",
                                    isTeamsActive ? "text-white" : "text-white group-hover:text-primary dark:group-hover:text-primary"
                                )}/>
                                <span className={cn(
                                     isTeamsActive ? "text-white" : "text-white group-hover:text-primary dark:group-hover:text-primary"
                    ...
                    <Link href={`/organization/${organizationId}/profile`} className="flex items-center gap-2">
                        ...
                        <div className="hidden lg:block">
                            <p className="text-base lg:text-lg font-medium text-white">{userName}</p>
