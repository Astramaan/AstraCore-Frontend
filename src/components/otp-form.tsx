      ...
      <div className="flex-grow space-y-6">
        ...
        <div className="space-y-2">
          <Label
            className={cn(
              "text-lg font-medium",
              hasOtp ? "text-muted-foreground" : "text-foreground",
            )}
          >
            Enter OTP
          </Label>
        ...
        <div className="flex justify-between items-center text-sm">
          <div>
            ...
            <button
              ...
              disabled={timer > 0}
              className="font-medium text-foreground underline hover:text-primary disabled:text-muted-foreground disabled:no-underline disabled:cursor-not-allowed"
            >
              Resend
            </button>
          </div>
