...
const DetailField = ({
  ...
  <div className={cn("flex items-start gap-4", fullWidth && "col-span-2")}>
    ...
    <div className="space-y-1 overflow-hidden">
      ...
      <div
        className={cn(
          "text-foreground text-base md:text-lg leading-tight",
          !fullWidth && "truncate",
        )}
      >
        {value}
          ...
          <div className={cn("space-y-6", personalInfo ? "" : "col-span-full")}>
            ...
            >
              ...
              <DetailField
                icon={<Calendar />}
                label="Duration"
                value={`${projectInfo.duration.start} - ${projectInfo.duration.end}`}
              />
              <DetailField
                icon={<Ruler />}
                label="Site Dimension"
                value={projectInfo.dimension}
              />
              <DetailField
                icon={<Layers />}
                label="Floors"
