...
const UpcomingTaskCard = ({ stage, onClick }: { stage: Stage, onClick: (stage: Stage) => void }) => {
    ...
    return (
        <Card className="w-full rounded-[40px] flex flex-col justify-between p-6 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onClick(stage)}>
            <div>
        ...
        <SheetHeader className="p-6 border-b shrink-0">
          <SheetTitle className="flex justify-between items-center">
           ...
           <div className="relative pt-4">
            <Search className="absolute left-4 top-1/2 -translate-y-[-10px] h-5 w-5 text-gray-400" />
            <Input
