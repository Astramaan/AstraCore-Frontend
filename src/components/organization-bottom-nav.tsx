                                ...
                                <Link href={baseHref} key={item.label} title={item.label} className="flex-shrink-0">
                                    <div className="relative p-px rounded-full bg-gradient-to-br from-white/50 to-white/0 dark:from-white/20 dark:to-white/0">
                                        <div className={cn(
                                            ...
                                            isActive ? "bg-primary text-primary-foreground dark:text-black px-4" : "bg-black/20 dark:bg-black/30 text-white w-[54px] md:w-14 hover:bg-primary/10 hover:text-primary"
                                        )}>
