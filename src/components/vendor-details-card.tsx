...
const DayToggle = ({ day, selectedDays, onDayToggle, isEditing }: { day: string; selectedDays: string[], onDayToggle: (day: string) => void, isEditing: boolean }) => {
...
export const VendorDetailsCard = ({ vendor, setVendor, isEditing }: { vendor: any, setVendor: Function, isEditing: boolean }) => {
    ...
    const handleCityKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'Enter') {
            ...
            if (city && !vendor.serviceableCities.includes(city)) {
                setVendor((prev: any) => ({...prev, serviceableCities: [...prev.serviceableCities, city]}));
    ...
    const removeCity = (cityToRemove: string) => {
        setVendor((prev: any) => ({
            ...prev,
            serviceableCities: prev.serviceableCities.filter((city: string) => city !== cityToRemove)
        }));
    };
    ...
    const handleDayToggle = (day: string) => {
        ...
        setVendor((prev: any) => ({...prev, availability: {...prev.availability, days: newDays}}));
    }

    const handleTimeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setVendor((prev: any) => ({...prev, availability: {...prev.availability, time: e.target.value}}))
    }
            ...
            <CardContent className="p-0">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <DetailField label="Time" name="time" value={vendor.availability.time} isEditing={isEditing} onChange={handleTimeChange} />
                    </div>
                </div>
            </CardContent>
        </Card>
