            ...
            <DialogContent className="sm:max-w-md bg-card rounded-[50px] p-10 mx-4">
                ...
                <div className="flex flex-col items-center gap-8">
                    <div className="text-center w-full">
                        <Button className="w-full h-[54px] rounded-full text-lg text-primary-foreground leading-tight">Visit Our Office</Button>
                        <p className="text-stone-400 text-sm mt-2">Meet with a Project specialist at our office.</p>
                    </div>
                    <div className="text-center w-full">
                        <Button className="w-full h-[54px] rounded-full text-lg text-primary-foreground leading-tight">Home Visit</Button>
