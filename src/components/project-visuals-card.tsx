        ...
        <SheetHeader className="p-4 border-b flex-row items-center justify-between">
          ...
          <SheetClose asChild>
            <Button
              variant="ghost"
              size="icon"
              className="rounded-full bg-background w-[54px] h-[54px]"
            >
              <X className="h-5 w-5" />
            </Button>
          </SheetClose>
  ...
  return (
    <>
      <Card className="rounded-[50px] bg-card">
        <CardContent className="p-10 flex flex-col gap-8">
          <ImageGrid
            ...
            onImageClick={(index) =>
              openPreview(visuals["3d"], "3D Visualize", index)
            }
          />
          ...
          <ImageGrid
            ...
            onImageClick={(index) =>
              openPreview(visuals.gallery, "Gallery", index)
            }
          />
        </CardContent>
      </Card>
      ...
      <ImageGallerySheet
        ...
        onImageClick={(index) =>
          openPreview(sheetState.images, sheetState.title, index)
        }
      />
      <ImagePreviewDialog
