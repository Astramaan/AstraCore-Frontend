...
const AddTaskForm = ({ onTaskAssigned, onClose }: AddTaskFormProps) => {
  ...
  const [priority, setPriority] = useState<"High" | "Low" | "Medium" | null>(
    null,
  );
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <Label
                ...
                className={cn(
                  "text-lg font-medium",
                  title ? "text-grey-1" : "text-zinc-900 dark:text-white",
                )}
              >
                Task Title*
              </Label>
            ...
            <div className="space-y-2">
              <Label
                ...
                className={cn(
                  "text-lg font-medium",
                  description ? "text-grey-1" : "text-zinc-900 dark:text-white",
                )}
              >
                Description
              </Label>
            ...
            <div className="space-y-2">
              <Label
                ...
                className={cn(
                  "text-lg font-medium",
                  members ? "text-grey-1" : "text-zinc-900 dark:text-white",
                )}
              >
                Members*
              </Label>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <Label
                className={cn(
                  "text-lg font-medium",
                  date ? "text-grey-1" : "text-zinc-900 dark:text-white",
                )}
              >
                Due Date*
              </Label>
            ...
            <div className="space-y-2">
              <Label
                ...
                className={cn(
                  "text-lg font-medium",
                  category ? "text-grey-1" : "text-zinc-900 dark:text-white",
                )}
              >
                Category
              </Label>
            ...
            <div className="space-y-2">
              <Label className="text-lg font-medium text-zinc-900 dark:text-white">
                Attach Files
              </Label>
              <div
