...
const CreateMeetingForm = ({
  ...
  const handleMeetingLinkChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const isZoom =
      /^(https?:\/\/)?([a-z]+\.)?zoom\.us\/(j|my)\/[a-zA-Z0-9?=&-.]+$/.test(
        link,
      );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
          <div className="space-y-2 sm:col-span-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                title ? "text-grey-1" : "text-foreground",
              )}
            >
              Title*
            </Label>
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                meetingLink ? "text-grey-1" : "text-foreground",
              )}
            >
              Meeting Link*
            </Label>
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                participants.length > 0 ? "text-grey-1" : "text-foreground",
              )}
            >
              Add Members*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              className={cn(
                "text-lg font-medium",
                date ? "text-grey-1" : "text-foreground",
              )}
            >
              Date*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              className={cn(
                "text-lg font-medium",
                time ? "text-grey-1" : "text-foreground",
              )}
            >
              Time*
            </Label>
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label
              htmlFor="client-lead-id"
              className={cn(
                "text-lg font-medium",
                selectedId ? "text-grey-1" : "text-foreground",
              )}
            >
              Client/Lead*
            </Label>
            <Popover open={comboboxOpen} onOpenChange={setComboboxOpen} modal={true}>
              <PopoverTrigger asChild>
                ...
                >
                  {selectedId
                    ? allContacts.find((contact) => contact.id === selectedId)
                        ?.name
          ...
          <div className="sm:col-span-2 space-y-4">
            <div className="flex items-center justify-end gap-2">
              <Label htmlFor="manual-switch" className="text-sm">
            ...
            <>
              <div className="space-y-2">
                <Label
                  ...
                  className={cn(
                    "text-lg font-medium",
                    targetType ? "text-grey-1" : "text-foreground",
                  )}
                >
                  Type*
                </Label>
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className={cn(
                    "text-lg font-medium",
                    name ? "text-grey-1" : "text-foreground",
                  )}
                >
                  Name*
                </Label>
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className={cn(
                    "text-lg font-medium",
                    email ? "text-grey-1" : "text-foreground",
                  )}
                >
                  Email*
                </Label>
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className={cn(
                    "text-lg font-medium",
                    phone ? "text-grey-1" : "text-foreground",
                  )}
                >
                  Phone*
                </Label>
        ...
        <AlertDialogContent className="max-w-md rounded-[50px]">
          <AlertDialogHeader className="items-center text-center">
            <div className="relative mb-6 flex items-center justify-center h-20 w-20">
              <ShieldAlert className="w-8 h-8 dark:text-white" />
            </div>
