      ...
      <div className="flex flex-col">
        ...
        <div className="md:hidden flex flex-col px-6 py-4">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4 flex-1">
              <Link
                href={`/organization/vendors/${vendor.id}`}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => setIsOrderFormOpen(true)}>
                  Order
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ...
          <div className="mt-2 space-y-1 text-sm">
            <p className="whitespace-nowrap">
              <span className="text-grey-1">Contact: </span>
              <span className="text-foreground font-medium">
                {vendor.phone} | {vendor.email}
              </span>
            </p>
            <p>
              <span className="text-grey-1">Location: </span>
              <span className="text-foreground font-medium">
                {vendor.location}
              </span>
            </p>
            <div className="pt-6">
              <Button
                ...
                className="w-full h-[54px] rounded-full bg-primary text-primary-foreground"
              >
                Order
              </Button>
            </div>
        ...
        <div className="hidden md:grid md:grid-cols-[1.5fr_auto_1.5fr_auto_1fr] items-stretch py-4">
          ...
          <div className="flex items-center justify-end gap-4 pl-4">
            <Button
              onClick={() => setIsOrderFormOpen(true)}
              className="h-12 rounded-full px-6 bg-primary text-primary-foreground"
            >
              Order
            </Button>
            <StarIcon
              isFilled={vendor.isFavorite}
...
export function ViewVendorsSheet({
  isOpen,
  onClose,
  material,
}: ViewVendorsSheetProps) {
