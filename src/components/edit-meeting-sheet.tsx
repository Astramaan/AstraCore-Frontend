        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
          <div className="space-y-2 sm:col-span-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                title ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Title*
            </Label>
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                meetingLink ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Meeting Link*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                participants.length > 0 ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Add Members*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              className={cn(
                "text-lg font-medium",
                date ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Date*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              className={cn(
                "text-lg font-medium",
                time ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Time*
            </Label>
          ...
          <div className="space-y-2">
            <Label
              ...
              className={cn(
                "text-lg font-medium",
                selectedId ? "text-grey-1" : "text-zinc-900",
              )}
            >
              Client/Lead*
            </Label>
