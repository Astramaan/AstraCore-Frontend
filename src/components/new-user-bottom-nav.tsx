...
export const NewUserBottomNav = () => {
    ...
    const navItems = [
        { href: `${pathname}#book-consultation-section`, icon: Calendar, label: "Book" },
        { href: `${pathname}#features`, icon: Sparkles, label: "Features" },
        { href: `${pathname}#faq-section`, icon: HelpCircle, label: "FAQ's" },
    ];
                        ...
                        return (
                             <Link href={item.href} key={item.label} title={item.label} className="flex-shrink-0">
                                <div className={cn(
                                    ...
                                    "bg-white text-black hover:bg-white hover:text-primary"
                                )}>
