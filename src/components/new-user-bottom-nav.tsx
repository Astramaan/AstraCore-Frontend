...
export const NewUserBottomNav = () => {
  ...
  const navItems = [
    {
      href: `/organization/${organizationId}/client/lead/${leadId}/home`,
      icon: HomeIcon,
      label: "Home",
    },
    {
      href: `/organization/${organizationId}/client/lead/${leadId}/packages`,
      icon: Award,
      label: "Packages",
    },
    {
      href: `/organization/${organizationId}/client/lead/${leadId}/projects`,
      icon: ProjectsIcon,
      label: "Projects",
    },
    {
      href: `/organization/${organizationId}/client/lead/${leadId}/profile`,
      icon: User,
      label: "Profile",
    },
  ];
