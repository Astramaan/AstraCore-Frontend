            ...
            <ScrollArea className="flex-1 p-6 no-scrollbar">
                <div className="space-y-6">
                    <div className="space-y-2">
                        <Label htmlFor="rework-comments" className={cn("text-lg font-medium", comments ? 'text-grey-1' : 'text-zinc-900')}>Comments</Label>
                        <Textarea 
                            id="rework-comments" 
                            className="h-32 bg-background rounded-2xl" 
                            value={comments} 
                            onChange={(e) => setComments(e.target.value)}
                            placeholder="Provide detailed feedback for the rework..."
                        />
                    </div>
