    ...
    <div className="flex flex-col h-full">
      ...
      {isEditing ? (
        ...
        <div className="p-4 border-t mt-auto flex justify-end">
          <Button className="w-full md:w-auto h-[54px] text-base md:px-6 rounded-full bg-primary/10 text-primary border border-primary hover:bg-primary/20 font-medium">
            Request 1% Token
          </Button>
        </div>
      )}
