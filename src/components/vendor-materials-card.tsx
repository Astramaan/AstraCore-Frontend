...
const EditMaterialForm = ({
  ...
  return (
    <form
      ...
      className="space-y-4 p-4 border rounded-[25px] my-4 bg-background dark:bg-input"
    >
      <div className="flex items-center gap-4">
        <Image
          src={editedMaterial.image}
          width={100}
          height={100}
        ...
        <div className="flex-1 space-y-2">
          <div>
            ...
            <Input
              ...
              className="rounded-full bg-background h-12"
            />
          </div>
          <div>
          ...
          {filteredMaterials.map((material, index) => (
            <React.Fragment key={material.id}>
              ...
              {index < filteredMaterials.length - 1 && (
                <Separator
                  style={{ backgroundColor: "#c0c0c0", height: "0.5px" }}
                />
              )}
            </React.Fragment>
          ))}
