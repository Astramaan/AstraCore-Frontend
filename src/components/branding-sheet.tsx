...
export const BrandingSheet = ({
  ...
  const handleGenerateAiContent = async () => {
    if (!companyDescription.trim()) {
      toast({
        ...
        description:
          "Please provide a brief description of your company to generate content.",
      });
      return;
    }
    setIsAiContentLoading(true);
    try {
      const result: ContentSuggestionOutput = await getContentSuggestions({
        companyDescription,
      });
      setBulletPoints(
        result.bulletPoints.map((bp) => ({
          text: bp,
  ...
  const handleSocialMediaChange = (
    platform: keyof typeof socialMediaLinks,
    value: string,
  ) => {
      ...
      >
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <SheetDescription className="text-muted-foreground">
                These customizations will reflect on the client version of your
                organization.
              </SheetDescription>
            </div>
            <SheetClose asChild>
              <Button
                variant="ghost"
                size="icon"
                className="w-[54px] h-[54px] bg-background rounded-full shrink-0"
              >
                <X className="h-5 w-5" />
              </Button>
            </SheetClose>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  ...
                  <label
                    ...
                    className="cursor-pointer aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-muted-foreground hover:bg-accent"
                  >
              ...
              <div className="space-y-4">
                ...
                >
                  <Sparkles
                    className={cn(
                      "w-4 h-4 mr-2",
                      isAiContentLoading && "animate-spin",
                    )}
                  />
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Toggle the visibility of the "Submit Your Project Details"
                  form on the new user homepage.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {packages.map((pkg, pkgIndex) => (
                    <div
                      key={pkgIndex}
                      className="p-4 border rounded-2xl space-y-4 bg-background dark:bg-input"
                    >
                      <div className="flex items-center justify-between">
                        <Button
                          size="sm"
                          variant={pkg.isPopular ? "secondary" : "outline"}
                          onClick={() => setPopularPackage(pkgIndex)}
                      ...
                      <Input
                        ...
                        className="text-xl font-bold bg-transparent border-0 p-0"
                      />
                      <Input
                        value={pkg.price}
                        onChange={(e) =>
              ...
              <div className="space-y-4">
                ...
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="space-y-2 p-4 border rounded-2xl relative bg-background dark:bg-input"
                  >
                    <Button
                      size="icon"
                      variant="ghost"
          ...
          <div className="px-6 py-4 border-t flex justify-end shrink-0">
            <Button
              className="h-14 rounded-full text-lg px-10"
              onClick={handleSave}
            >
