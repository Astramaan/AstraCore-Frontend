...
export const ChangePasswordDialog = ({
  ...
  const defaultTrigger = (
    <Button
      variant="outline"
      className="w-full md:w-56 h-14 px-10 rounded-full bg-card text-foreground hover:bg-muted text-lg font-medium"
    >
      Change Password
    </Button>
  );
          ...
          <SheetTitle className="flex justify-between items-center">
            ...
            <SheetClose asChild>
              <Button
                variant="ghost"
                size="icon"
                className="w-[54px] h-[54px] bg-background hover:bg-muted rounded-full"
              >
                <X />
              </Button>
            </SheetClose>
