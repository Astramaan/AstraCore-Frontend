...
const allStages: Stage[] = [
  ...
  },
  {
    ...
    category: "Civil",
    image: "https://picsum.photos/seed/excavation/100/100",
    duration: "2 Days",
    status: "ongoing",
    type: "stage",
    siteImages: [
      "https://picsum.photos/seed/site1/150/150",
      "https://picsum.photos/seed/site2/150/150",
      "https://picsum.photos/seed/site3/150/150",
      "https://picsum.photos/seed/site4/150/150",
    ],
    snagCount: 3,
  ...
  },
  {
    ...
    subtitle: "Excavation Stage",
    category: "Civil",
    image: "https://picsum.photos/seed/grid/100/100",
    duration: "2 Days",
    status: "upcoming",
    type: "stage",
    createdBy: "Site Supervisor",
  ...
  },
  {
    id: 7,
    title: "Framing",
    subtitle: "Super-structure",
    category: "Carpentry",
    image: "https://picsum.photos/seed/framing/100/100",
    duration: "7 Days",
    status: "upcoming",
    type: "stage",
    createdBy: "Site Supervisor",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-card rounded-full px-6 py-4 flex flex-col md:flex-row justify-between md:items-center gap-4">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            <a
              href={`tel:${project.siteSupervisorPhone}`}
        ...
        <div className="bg-card rounded-full py-4 px-6 flex flex-col md:flex-row justify-between md:items-center gap-4">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            <a
              href={`tel:${project.architectPhone}`}
              className="flex-1 md:flex-initial"
            >
              <Button variant="outline" className="rounded-full" size="icon">
                <Phone className="h-4 w-4" />
...
export default function ProjectManagerHome() {
  ...
  const handleUpdateTask = (updatedTask: Task) => {
    ...
    const stageToUpdate = allStages.find(
      (s) => s.id.toString() === updatedTask.id,
    );
    if (stageToUpdate) {
  ...
  const upcomingTasks = useMemo(
    () =>
      allStages.filter(
        (stage) => stage.status === "upcoming" || stage.status === "pending",
      ),
    [],
  );
  ...
  const projectTasksChartData = useMemo(() => {
    ...
    const ongoing = selectedProject.tasks.filter(
      (t) => t.status === "ongoing",
    ).length;
    const upcoming = selectedProject.tasks.filter(
      (t) => t.status === "upcoming",
    ).length;
    return [
