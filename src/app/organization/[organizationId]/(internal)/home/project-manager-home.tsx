    ...
    return (
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-card rounded-full px-6 py-4 flex flex-col md:flex-row justify-between md:items-center gap-4">
              <div>
            ...
            <div className="bg-white dark:bg-card rounded-full py-4 px-6 flex flex-col md:flex-row justify-between md:items-center gap-4">
              <div>
