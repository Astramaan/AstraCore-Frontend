    ...
    <div className="min-h-screen bg-background">
        <header className="sticky top-4 z-20 px-4">
          <div className="relative p-px rounded-full bg-gradient-to-b from-white/50 to-white/0">
            <div className="relative w-full bg-black/10 rounded-full backdrop-blur-[5px] p-2">
        ...
        <main className="max-w-[1440px] 2xl:max-w-none w-full flex-1 overflow-y-auto bg-background pb-32 md:pb-40 pt-4 px-4 md:px-8 2xl:px-10 space-y-6">
            {children}
        </main>
