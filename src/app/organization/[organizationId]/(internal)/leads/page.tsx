...
const LeadCard = ({
  ...
  <div className="flex flex-col group">
    {/* Desktop View */}
    <div
      className="hidden lg:block py-6 px-10 hover:bg-hover-bg dark:hover:bg-muted/50 cursor-pointer"
        ...
        <div className="flex items-center gap-4">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onSelectionChange(lead.leadId, !!checked)
            }
        ...
        >
          <div className="flex items-center gap-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem
                  onSelect={() => onLevelChange(lead.leadId, "Level 1")}
                >
                  Level 1
                </DropdownMenuItem>
                <DropdownMenuItem
                  onSelect={() => onLevelChange(lead.leadId, "Level 2")}
                >
                  Level 2
                </DropdownMenuItem>
                <DropdownMenuItem
                  onSelect={() => onLevelChange(lead.leadId, "Level 3")}
                >
                  Level 3
                </DropdownMenuItem>
              </DropdownMenuContent>
              ...
              <AlertDialogContent className="max-w-md rounded-[50px]">
                <AlertDialogHeader className="items-center text-center">
                  <div className="relative mb-6 flex items-center justify-center h-20 w-20">
                    <div className="w-full h-full bg-red-600/10 rounded-full" />
    ...
    {/* Mobile View */}
    <div
      className="block lg:hidden p-6 md:p-10"
      onClick={() => onViewDetails(lead)}
    >
        ...
        <div className="col-span-2 flex flex-col sm:flex-row items-center gap-4 pt-2 w-full">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                className="w-full h-12 px-6 rounded-full text-foreground text-base font-medium justify-between hover:bg-primary/10 hover:text-primary"
                onClick={(e) => e.stopPropagation()}
              >
                {lead.level}
                <ChevronDown className="ml-2" />
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-12 px-4 rounded-full text-foreground text-base font-medium hover:bg-primary/10 hover:text-primary"
          >
            <Phone className="mr-2 h-4 w-4" />
            Contact
          </Button>
...
export default function LeadsPage() {
  ...
  const handleDelete = (leadsToDelete: string[]) => {
    setAllLeads((prev) =>
      prev.filter((lead) => !leadsToDelete.includes(lead.leadId)),
    );
    setSelectedLeads((prev) =>
      prev.filter((id) => !leadsToDelete.includes(id)),
    );
    if (
      selectedLeadDetails &&
      leadsToDelete.includes(selectedLeadDetails.leadId)
    ) {
  ...
  return (
    <div className="space-y-8 pb-28">
      ...
      <Dialog
        ...
        onOpenChange={setIsUpdateLevelDialogOpen}
      >
        <DialogContent className="sm:max-w-sm rounded-3xl p-8">
          ...
          <div className="text-center flex flex-col items-center">
            ...
            <DialogTitle className="text-lg font-semibold">
              Update the leads level
            </DialogTitle>
            <p className="text-base text-foreground">
              {contactedLead?.fullName}, {contactedLead?.phone}
            </p>
        ...
        <AlertDialog>
          <FloatingActionBar
            ...
            deleteTrigger={
              <AlertDialogTrigger asChild>
                <Button
                  variant="destructive"
                  className="h-14 px-4 md:px-10 rounded-[50px] bg-background hover:bg-destructive/10 text-red-600 hover:text-red-600 text-sm md:text-lg font-medium"
                >
          ...
          <AlertDialogContent className="max-w-md rounded-[50px]">
            <AlertDialogHeader className="items-center text-center">
              ...
              <AlertDialogDescription className="text-lg text-muted-foreground">
                The selected leads and all associated data will be permanently
                removed from AstraCore.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter className="sm:justify-center gap-4 pt-4">
              <AlertDialogCancel className="w-40 h-14 px-10 rounded-[50px] text-lg font-medium text-foreground border hover:bg-muted/80">
