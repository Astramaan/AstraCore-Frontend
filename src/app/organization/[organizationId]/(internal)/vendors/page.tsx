...
import {
  ViewVendorsSheet,
  type Material,
} from "@/components/view-vendors-sheet";
...
const vendorsData = [
  ...
  },
  {
    ...
    email: "Company@gmail.com",
    address:
      "43, Second Floor, Leela Palace Rd, behind The Leela Palace, HAL 2nd Stage, Kodihalli, Mysuru, Karnataka 560008",
    image: "https://placehold.co/100x100.png",
    location: "Mysuru",
    area: "Hebbal",
    pincode: "570016",
  ...
  },
  {
    ...
    email: "Company@gmail.com",
    address:
      "43, Second Floor, Leela Palace Rd, behind The Leela Palace, HAL 2nd Stage, Kodihalli, Chennai, Karnataka 560008",
    image: "https://placehold.co/100x100.png",
    location: "Chennai",
    area: "T. Nagar",
    pincode: "600017",
...
const MaterialCard = ({
  ...
  material: Material;
  onViewVendors: (material: Material) => void;
}) => (
  <>
    <div className="hidden lg:grid lg:grid-cols-[1.2fr_auto_1fr_auto_1fr] items-stretch py-4 gap-4">
      <div className="flex items-center gap-4">
        <div
          className={
            "w-14 h-14 rounded-full flex items-center justify-center shrink-0 bg-blue-200/30"
          }
        >
      ...
      <div className="flex flex-col justify-center gap-2">
        <p className="text-lg">
          ...
          <span className="text-foreground font-medium">
            {material.vendors[0]?.companyName || "N/A"}
          </span>
        </p>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        <p className="text-lg">
          ...
          <span className="text-foreground font-medium">
            {String(material.vendors.length).padStart(2, "0")}
          </span>
        </p>
        <Button
          className="h-14 px-10 rounded-full bg-background text-foreground dark:text-white hover:bg-muted text-lg font-medium"
          onClick={() => onViewVendors(material)}
        >
          View Vendors
        </Button>
      </div>
    ...
    <div className="lg:hidden flex flex-col p-6 md:p-10 gap-4">
      ...
      <div className="grid grid-cols-2 items-center gap-4 mt-2">
        ...
        <div className="col-span-2">
          <Button
            className="h-12 px-6 w-full rounded-full bg-background text-foreground dark:text-white hover:bg-muted text-base font-medium"
            onClick={() => onViewVendors(material)}
          >
            View Vendors
          </Button>
      ...
      <div className="flex flex-col md:flex-row justify-end items-center gap-4">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          <Button
            variant="outline"
            className={cn(
              "h-[54px] md:h-14 justify-center rounded-full text-lg flex-1 md:flex-initial md:w-auto md:px-4 bg-card",
              showFavorites ? "bg-primary text-white" : "",
            )}
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                className="h-[54px] md:h-14 justify-center rounded-full bg-card text-lg flex-1 md:flex-initial md:w-auto md:px-4"
              >
