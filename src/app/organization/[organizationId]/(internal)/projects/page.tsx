    ...
    <div className="lg:hidden p-6 md:p-10 gap-4">
        ...
        >
          <AvatarWithProgress value={project.progress}>
            <Avatar className="w-14 h-14 shrink-0">
              <AvatarImage
                src={project.image}
                data-ai-hint="abstract building"
              />
      ...
      <div className="space-y-2 mt-4 ml-18 grid grid-cols-2 gap-x-4 gap-y-2">
        <div>
          ...
          <p className="text-foreground font-medium text-base break-words">
            {project.contact.split(" | ")[0]}
            <br />
            {project.contact.split(" | ")[1]}
          </p>
        </div>
        ...
        <div className="text-right">
          ...
          <p className={cn(project.statusColor, "font-medium text-base")}>
            {project.status}
          </p>
        </div>
      </div>
...
export default function ProjectsPage() {
  ...
  const canCreateProject =
    user?.role === "ORG_ADMIN" || user?.team === "Project Manager";
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl text-foreground font-medium mb-4">
          Completed Projects
        </h2>
        <Card className="rounded-[40px] md:rounded-[50px] bg-card">
          <CardContent className="p-0 lg:p-6">
