        ...
        <div className="bg-zinc-100 min-h-screen">
            <main>
                <div className="max-w-[1240px] mx-auto px-0 md:px-4">
                    <Card className="rounded-lg text-card-foreground w-full p-4 md:p-10 bg-white rounded-[50px] flex flex-col justify-start items-center">
                    ...
                    <Card className="text-card-foreground w-full mt-8 p-4 md:p-8 bg-white rounded-[50px]">
