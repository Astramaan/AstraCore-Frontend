      ...
      <main className="relative z-10 mt-[30vh] md:mt-[40vh]">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 px-4 sm:px-4 md:px-8 2xl:px-10 pb-32">
          ...
          <div className="md:col-span-1 space-y-8 flex flex-col">
            ...
            {/* FORM → Mobile order-2, Desktop bottom-left */}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <Label htmlFor="project-type" className="px-4">
                            Project Type
                          </Label>
                          <Input
                            id="project-type"
                            placeholder="e.g. Residential, Commercial"
                            className="h-14 rounded-full bg-background dark:bg-input"
                          />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="floor-count" className="px-4">
                            Number of Floors
                          </Label>
                          <Input
                            id="floor-count"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="site-address" className="px-4">
                          Site Address
                        </Label>
                        <Textarea
                          id="site-address"
                          placeholder="Enter the full site address"
                          className="rounded-3xl bg-background dark:bg-input min-h-[100px]"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-center w-full">
                          <label
                            ...
                            className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-2xl cursor-pointer bg-background hover:bg-muted"
                          >
