            ...
            <div className="absolute top-0 left-0 w-full h-[50vh] -z-10">
             ...
             <main className="relative z-10 mt-[30vh] md:mt-[40vh]">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-4 md:px-8 2xl:px-10 pb-32">
                     ...
                     <div className="order-2 md:order-1 md:col-span-2 lg:col-span-1 space-y-8">
                        ...
                        <Card id="book-consultation-section" className="order-1 md:order-2 text-card-foreground w-full p-0 bg-transparent border-none shadow-none flex flex-col justify-start items-center">
