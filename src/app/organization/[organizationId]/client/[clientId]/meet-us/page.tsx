...
const FeatureCard = ({
  ...
  <div className="flex flex-col items-center gap-4 text-center z-10">
    ...
    <p className="text-foreground text-sm font-normal leading-none max-w-24">
      {text}
    </p>
  </div>
);
      ...
      <Card className="w-full max-w-sm rounded-[50px] p-6 text-center">
        <CardContent className="p-0">
          ...
          <div className="space-y-4">
            ...
            <Button
              variant="outline"
              className="w-full h-14 rounded-full text-primary border-primary bg-primary/10 hover:bg-primary/20"
...
export default function MeetUsPage() {
  ...
  const [consultationType, setConsultationType] = useState<
    "office" | "home" | "online" | "in-person" | null
  >(null);
  ...
  const openConsultationDialog = (
    type: "office" | "home" | "online" | "in-person",
  ) => {
      ...
      <main>
        <div className="max-w-[1240px] mx-auto space-y-8 md:p-8 pb-32">
          <Card
            ...
            className="text-card-foreground w-full p-[40px] bg-card rounded-[50px] flex flex-col justify-start items-center"
          >
            {appointment ? (
              <AppointmentCard
                ...
                onReschedule={() => {
                  ...
                  openConsultationDialog(
                    appointment.type === "office" || appointment.type === "home"
                      ? "in-person"
                      : appointment.type,
                  );
                }}
              ...
              <>
                <Card className="w-full max-w-3xl rounded-[50px] flex flex-col justify-center items-center p-0">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <Button
                      className="w-full md:w-64 h-[54px] rounded-full text-lg"
          ...
          <Card className="text-card-foreground w-full p-10 bg-card rounded-[50px]">
            <CardContent className="p-0">
              <h2 className="text-center text-foreground text-lg font-normal leading-tight mb-8">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-4 gap-y-8 gap-x-4 justify-items-center">
                  <FeatureCard
                    icon={<GanttChartSquare className="text-white" />}
                    text="Unique Design"
                  />
                  <FeatureCard
                    icon={<GanttChartSquare className="text-white" />}
                    text="Efficient planning"
                  />
                  <FeatureCard
                    icon={<Shield className="text-white" />}
                    text="Disaster Resilient"
                  />
                  <FeatureCard
          ...
          <Card
            id="faq-section"
            className="text-card-foreground w-full p-10 bg-card rounded-[50px]"
          >
            <CardContent className="p-0">
