  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="relative">
        <Image src={project.coverImage} width={393} height={350} alt="Project cover" className="w-full h-80 object-cover rounded-b-[50px]" data-ai-hint="house project"/>
        <div className="absolute inset-0 bg-gradient-to-b from-neutral-900/10 to-neutral-900 rounded-b-[50px]"></div>
        <Image src={project.profileImage} width={56} height={56} alt={project.name} className="absolute top-[68px] left-4 rounded-full border-[3px] border-slate-50 shadow" data-ai-hint="person portrait"/>
      </div>
