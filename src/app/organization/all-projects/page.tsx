...
const projects = [
  ...
  {
    name: "Sunrise Bridge",
    organization: "InfraBuild",
    status: "Completed",
    deadline: "2024-03-15",
  },
  {
    name: "Oceanview Residences",
    organization: "Luxury Homes",
    status: "In Progress",
    deadline: "2024-09-01",
  },
  {
    name: "Eco Park Development",
    organization: "GreenScape",
    status: "Not Started",
    deadline: "2025-01-20",
  },
];
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            An overview of all projects across all organizations.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
