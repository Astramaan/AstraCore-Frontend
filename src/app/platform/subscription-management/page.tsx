  ...
  monthly: [
    {
      ...
      headerBg: "bg-gradient-to-bl from-purple-200 to-transparent",
      Icon: Users,
      basePlan: true,
    },
    {
      ...
      headerBg: "bg-gradient-to-bl from-indigo-200 to-transparent",
      Icon: Users,
      basePlan: true,
    },
    {
      ...
      headerBg: "bg-gradient-to-bl from-rose-200 to-transparent",
      Icon: Users,
      basePlan: true,
    },
  ],
